...
**Outcome.** By the end of this tutorial, Peter's project, PB Office Hours is open through Codex in the ChatGPT desktop app and you have completed and saved your first Prototype Plan.  PBOH is a knowledge bundle — course material coupled with the instructions that turn an LLM into your guide.  
